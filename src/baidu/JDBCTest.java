...
public class JDBCTest {
	...
	public static void testCallableStatment() {
		...
		try {
			...
			String sql="insert into Student(stunumber,name,sex,xuezhi,yuanxi) values('1330090003','胡永涛','男','4','计信学院')";
...
//
//			// 3. 通过 CallableStatement 对象的 setXxx() 方法设定 IN 或 IN OUT 参数.
//			// 若想将参数默认值设为
...
//		}
	...
	public static void testC3P0() throws SQLException {
		DataSource dataSource = new ComboPooledDataSource("c3p0");

		System.out.println(dataSource.getConnection());
		System.out.println("我想看到成功");
	}
